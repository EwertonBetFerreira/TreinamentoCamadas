...
using Treinamento.Apresentacao.Cmd.Features.Funcionarios;
using Treinamento.Apresentacao.Cmd.Features.Operacoes;
using Treinamento.Apresentacao.Cmd.Features.Pessoas;
using Treinamento.Infra.Memoria;
using Treinamento.Infra.Memoria.Contas;
using Treinamento.Infra.Memoria.Funcionarios;
using Treinamento.Infra.Memoria.Operacoes;
using Treinamento.Infra.Memoria.Pessoas;

namespace Treinamento.Apresentacao.Cmd.Menus
{
